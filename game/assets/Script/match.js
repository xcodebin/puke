...
cc.Class({
    ...
    onLoad: function () {
        ...
        window.socket.on('joinroom' + PersonMsg.id, (param) => {
            ...
            if (param.status === true) {
                ...
                var r = {
                    roomid: param.msg.roomid, player1: param.msg.number1, player2: param.msg.number2,
        ...
        //  展示人数 
        window.socket.on('selectnum' + PersonMsg.name, (param) => {
            param = JSON.parse(param);
            console.log(param);
    ...
    jinxiang: function () {
        ...
        window.socket.emit('selectnum', data)
    },
    yinxiang: function () {
        this.baoxiang.active = false;
        this.fangfei.active = true;
    ...
    buttonOnclick: function () {
        ...
        switch (this.coinType) {
            case 'sliver': if (PersonMsg.Scoin < this.moneyType) {
                ...
                self.schedule(timeCallback, 1.5, 0, 0.5); return;
            } break;
        ...
        window.socket.emit('joinroom', param);
        window.socket.emit('Gsavenum', param);
