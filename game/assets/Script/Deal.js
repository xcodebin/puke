...
cc.Class({
    ...
    onLoad: function () {
        ...
        window.socket.on('tuifangS' + m.name, (msg) => {
            msg = JSON.parse(msg);
            cc.director.loadScene('Match');
        });
        window.socket.on(th.room + 'Deal', function (msg) {
            msg = JSON.parse(msg);
            // if(th.flag==0){
            //     var a=[];
            //     a[0]=msg.id1;
            ...
            //     window.socket.emit('paipai',{uid:msg.uid,a:JSON.stringify(a)});
            //     th.flag++;
            //  }
